...
export class init1621435866671 implements MigrationInterface {
    name = 'init1621435866671'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "test_cases" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "test_brief" character varying NOT NULL, "challenge_id" integer NOT NULL, CONSTRAINT "PK_39eb2dc90c54d7a036b015f05c4" PRIMARY KEY ("id"))`);
